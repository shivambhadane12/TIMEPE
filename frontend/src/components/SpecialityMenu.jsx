...
const SpecialityMenu = () => {
    return (
        <div id='speciality' className='flex flex-col items-center gap-4 py-16 text-[#262626]'>
            <h1 className='text-3xl font-medium'>Find by Cities</h1>
            <p className='sm:w-1/3 text-center text-sm'>Simply browse through our bank list, schedule your slot hassle-free.</p>
